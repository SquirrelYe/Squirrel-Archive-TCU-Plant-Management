...
(function (g, r, h, t, v) {
    ...
    if ((c = c.prop("value")))
      (c = c.split(";")),
        ...
        b && b.values && b.values.length
          ? ((a.from = c[0] && b.values.indexOf(c[0])),
            (a.to = c[1] && b.values.indexOf(c[1])))
          : ((a.from = c[0] && +c[0]), (a.to = c[1] && +c[1]));
    b = g.extend(a, b);
  ...
  q.prototype = {
    init: function (a) {
      this.coords.p_step =
        this.options.step / ((this.options.max - this.options.min) / 100);
      this.target = "base";
      this.toggleInput();
      this.append();
      this.setMinMax();
        ...
        if (this.coords.w_rs) {
          ...
          switch (this.target) {
            ...
            case "single":
              ...
              this.coords.p_single = this.toFixed(
                (this.coords.p_single_real / 100) * a
              );
              break;
            case "from":
              if (this.options.from_fixed) break;
            ...
            case "both":
              ...
              this.coords.p_from_real = this.calcWithStep(
                ((b - this.coords.p_gap_left) / a) * 100
              );
              this.coords.p_from_real = this.checkDiapason(
                this.coords.p_from_real,
                this.options.from_min,
              ...
              this.coords.p_to_real = this.calcWithStep(
                ((b + this.coords.p_gap_right) / a) * 100
              );
              this.coords.p_to_real = this.checkDiapason(
                this.coords.p_to_real,
                this.options.to_min,
    ...
    drawShadow: function () {
      ...
      "single" === a.type
        ? a.from_shadow && (c || d)
          ? ((c = this.calcPercent(a.from_min || a.min)),
        ...
        : (a.from_shadow && (c || d)
            ? ((c = this.calcPercent(a.from_min || a.min)),
              ...
              (b.shad_from[0].style.left = c + "%"),
              (b.shad_from[0].style.width = d + "%"))
            : (b.shad_from[0].style.display = "none"),
          a.to_shadow && (e || f)
            ? ((e = this.calcPercent(a.to_min || a.min)),
    ...
    calcPercent: function (a) {
      return this.toFixed(
        (a - this.options.min) / ((this.options.max - this.options.min) / 100)
      );
    },
    calcReal: function (a) {
      ...
      (d = this.options.step.toString().split(".")[1])
        ? (a = a !== b && a !== c ? +a.toFixed(d.length) : +a.toFixed(l))
        : ((a /= this.options.step),
          (a *= this.options.step),
          (a = +a.toFixed(0)));
      g && ((a -= g), (b = this.options.min), (c = this.options.max));
      b = d
        ? a !== b && a !== c
          ? +a.toFixed(d.length)
          : +a.toFixed(l)
      ...
      b < this.options.min
        ? (b = this.options.min)
        : b > this.options.max && (b = this.options.max);
      return b;
    },
    ...
    checkMinInterval: function (a, b, c) {
      ...
      b = this.calcReal(b);
      "from" === c
        ? b - a < d.min_interval && (a = b - d.min_interval)
    ...
    checkMaxInterval: function (a, b, c) {
      ...
      b = this.calcReal(b);
      "from" === c
        ? b - a > d.max_interval && (a = b - d.max_interval)
        : a - b > d.max_interval && (a = b + d.max_interval);
      return this.calcPercent(a);
    },
    ...
    decorate: function (a, b) {
      ...
      d.max_postfix &&
        (d.values.length && a === d.p_values[d.max]
          ...
          : b === d.max && ((c += d.max_postfix), d.postfix && (c += " ")));
    ...
    appendGrid: function () {
      if (this.options.grid) {
        ...
        this.calcGridMargin();
        a.grid_snap
          ? ((d = b / a.step), (e = this.toFixed(a.step / (b / 100))))
          : (e = this.toFixed(100 / d));
        4 < d && (k = 3);
        7 < d && (k = 2);
        14 < d && (k = 1);
        28 < d && (k = 0);
    ...
    calcGridLabels: function () {
      ...
      this.options.force_edges &&
        ...
        c[d - 1] > 100 + this.coords.grid_gap &&
          ((c[d - 1] = 100 + this.coords.grid_gap),
          (b[d - 1] = this.toFixed(c[d - 1] - this.coords.big_p[d - 1])),
          (this.coords.big_x[d - 1] = this.toFixed(
            this.coords.big_p[d - 1] - this.coords.grid_gap
          ))));
  ...
  g.fn.ionRangeSlider = function (a) {
    return this.each(function () {
      g.data(this, "ionRangeSlider") ||
        g.data(this, "ionRangeSlider", new q(this, a, u++));
    });
  };
  (function () {
    for (
      var a = 0, b = ["ms", "moz", "webkit", "o"], c = 0;
      c < b.length && !h.requestAnimationFrame;
      ++c
    )
      (h.requestAnimationFrame = h[b[c] + "RequestAnimationFrame"]),
        (h.cancelAnimationFrame =
          h[b[c] + "CancelAnimationFrame"] ||
          h[b[c] + "CancelRequestAnimationFrame"]);
