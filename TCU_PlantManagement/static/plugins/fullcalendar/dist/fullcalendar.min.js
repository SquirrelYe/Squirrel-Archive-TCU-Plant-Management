...
!(function (a) {
  ...
  var gb = fb.extend({
    ...
    updateCellDates: function () {
      for (
        var a = this.view, b = this.start.clone(), c = [], d = -1, e = [];
        b.isBefore(this.end);
  ...
  gb.mixin({
    ...
    gb.mixin({
          ...
          .on("click", function (f) {
            ...
            "function" == typeof g &&
              (g = e.trigger(
                "eventLimitClick",
                null,
                { date: h, dayEl: j, moreEl: i, segs: l, hiddenSegs: m },
                f
              )),
              "popover" === g
      ...
      getCellSegs: function (a, b) {
        for (
          var c, d = this.rowStructs[a.row].segMatrix, e = b || 0, f = [];
          e < d.length;
  ...
  hb.mixin({
    ...
    renderSegTable: function (b) {
      ...
      for (
        ...
        for (
          g = c[f], va(g), h = a('<div class="fc-event-container"/>'), d = 0;
          d < g.length;
          d++
        )
          (e = g[d]),
