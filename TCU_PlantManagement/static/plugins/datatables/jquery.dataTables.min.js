...
(function (Fa, T, k) {
  var S = function (g) {
    ...
    function Na(a, b) {
      ...
      if (c) {
        ...
        e.DT_RowClass &&
          ...
          g(c).removeClass(b.__rowc.join(" ")).addClass(e.DT_RowClass));
        ...
        for (d = h.length; e < d; e++) {
          ...
          for (b = h[e].length; f < b; f++)
            if (((n = j = 1), i[e][f] === k)) {
              ...
              for (
                i[e][f] = 1;
                h[e + j] !== k && h[e][f].cell == h[e + j][f].cell;
    ...
    function yb(a) {
      for (
        var b = m.ext.search, c = a.aiDisplay, e, d, f = 0, h = b.length;
        f < h;
        f++
      ) {
          ...
          for (m = h = 0; m < j.length; m++)
            (o = c[j[m]]),
              ...
              (h +=
                null === o.sWidthOrig
                  ? d
                  : parseInt(o.sWidth, 10) + d - g(n[m]).width());
          i.width(u(h));
          b.style.width = u(h);
        }
        for (m = 0; m < j.length; m++)
    ...
    function w(a, b, c, e) {
      ...
      null !== c &&
        ((b = g.Event(c + ".dt")), g(a.nTable).trigger(b, e), d.push(b.result));
      return d;
    }
    function Ta(a) {
      var b = a._iDisplayStart,
            ...
            if (g.isArray(a) || a instanceof g)
              ...
              a.nodeName && "tr" === a.nodeName.toLowerCase()
                ...
                : ((c = g("<tr><td/></tr>").addClass(b)),
                  (g("td", c).addClass(b).html(a)[0].colSpan = ba(e)),
                  d.push(c[0]));
          };
        f(a, b);
